...
public class WorldStabilized_Walking : MonoBehaviour
{
    ...
    void OnEnable()
    {
        countdownText.GetComponent<TextMesh>().text = "World Stabilized_Walking";
    ...
    IEnumerator Evaluation()
    {
        ...
        filename = "worldStabilized_walking_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".csv";
        frameNumber = 0;
