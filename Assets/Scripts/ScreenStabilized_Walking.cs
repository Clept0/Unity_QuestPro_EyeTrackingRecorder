...
public class ScreenStabilized_Walking : MonoBehaviour
{
    ...
    void OnEnable()
    {
        countdownText.GetComponent<TextMesh>().text = "Screen Stabilized_Walking";
    ...
    IEnumerator Evaluation()
    {
        ...
        filename = "screenStabilized_walking_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".csv";
        frameNumber = 0;
